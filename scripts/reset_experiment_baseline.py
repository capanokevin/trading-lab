...
def main() -> int:
    ...
    archive_path = archive_dir / f"{config.db_path.stem}-baseline-reset-{timestamp}.sqlite3"
    ...
    print(
        (
            "Baseline esperimento resettata. "
            f"Backup creato in {archive_path}. "
            "Market data preservati."
        ),
        flush=True,
    )
    return 0
